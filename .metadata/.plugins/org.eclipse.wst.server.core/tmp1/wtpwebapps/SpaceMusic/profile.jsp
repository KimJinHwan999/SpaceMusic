        ...
        <div class="row">
          <div class="col-12">
            <nav class="main-nav">
              ...
              <ul class="nav">
                <li class="dropdown">
                  <a href="#" class="dropdown-btn"><span style="color:#e75e8d; font-weight: bold; ">${udto.user_name }</span> 환영합니다.
                  <img src="./assets/images/${udto.user_picture }" alt="" /></a>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="main-profile ">
                <div class="row">
                  <div class="col-lg-4">
                  	<img src="http://localhost:8081/assets/images/${udto.user_picture }" alt="" style="border-radius: 23px; text-align: center;" />
                  </div>
