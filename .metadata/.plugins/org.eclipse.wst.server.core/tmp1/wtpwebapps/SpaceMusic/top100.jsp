              ...
              <div class="featured-games header-text" style="display: none;">
                ...
                <div class="owl-features owl-carousel">
                  <div class="item" style="text-align: center;">
                    <div class="thumb">
                      <img src="/assets/images_final/popular-03.jpg" style="border-radius: 23px;">
                  ...
                  <div class="item" style="text-align: center;" >
                    <div class="thumb">
                      <img src="/assets/images_final/popular-04.jpg" style="border-radius: 23px;">
                  ...
                  <div class="item" style="text-align: center;">
                    <div class="thumb">
                      <img src="/assets/images_final/popular-05.jpg" style="border-radius: 23px;">
                      <div class="hover-effect">
                        <h6>2.4K Streaming</h6>
                      </div>
                    </div>
                  ...
                  <div class="item" style="text-align: center;">
                    <div class="thumb">
                      <img src="assets/images_final/popular-02.jpg" style="border-radius: 23px;">
                      <div class="hover-effect">
                        <h6>2.4K Streaming</h6>
                      </div>
                    </div>
                  ...
                  <div class="item" style="text-align: center;">
                    <div class="thumb">
                      <img src="assets/images_final/popular-02.jpg" style="border-radius: 23px;" alt="">
                      <div class="hover-effect">
                        <h6>2.4K Streaming</h6>
                      </div>
                    </div>
